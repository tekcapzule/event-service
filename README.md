...
[![Main Branch](https://github.com/tekcapzule/event-service/actions/workflows/cicd.yml/badge.svg)](https://github.com/tekcapzule/event-service/actions/workflows/cicd.yml) 
[![SonarCloud Bugs](https://sonarcloud.io/api/project_badges/measure?project=tekcapzule_event-service&metric=bugs)](https://sonarcloud.io/project/overview?id=tekcapzule_event-service)
[![SonarCloud Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=tekcapzule_event-service&metric=vulnerabilities)](https://sonarcloud.io/project/overview?id=tekcapzule_event-service)
[![SonarCloud Code Smell](https://sonarcloud.io/api/project_badges/measure?project=tekcapzule_event-service&metric=code_smells)](https://sonarcloud.io/project/overview?id=tekcapzule_event-service)
[![SonarCloud Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=tekcapzule_event-service&metric=ncloc)](https://sonarcloud.io/project/overview?id=tekcapzule_event-service)
[![Github all releases](https://img.shields.io/github/downloads/tekcapzule/event-service/total.svg)](https://GitHub.com/tekcapzule/event-service/releases/)
...
<div align="center">
  ...
  <p align="center">
    ...
    <a href="https://github.com/tekcapzule/event-service/issues">Request Feature</a>
  </p>
</div>
<div align="center">
...
2. Clone the repo
   ```sh
   git clone https://github.com/tekcapzule/event-service.git
   ```
...
See the [open issues](https://github.com/tekcapzule/event-service/issues) for a list of proposed features (and known issues).
...
## Contributors
<img src= "https://contrib.rocks/image?repo=tekcapzule/event-service">
